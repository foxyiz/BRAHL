...
Run from KK/: python u/zDefects.py
Writes u/zDefectsDashboard.html.
"""
import csv
import re
...
from _paths import FOXYIZ_ROOT, Z_DEFECTS_DASHBOARD_HTML, Z_DIR

WORKSPACE = FOXYIZ_ROOT
Z_OUT = Z_DIR
OUT_HTML = Z_DEFECTS_DASHBOARD_HTML
