...
Usage (from KK/):
  python u/yVisualizer.py
  python u/yVisualizer.py --base . --out u/y_visualization.html
  python u/yVisualizer.py --config y/qoa_web/qoa_web.json
"""
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        type=Path,
        default=None,
        help="Output HTML path (default: u/y_visualization.html).",
    )
    ...
    from _paths import Y_VISUALIZATION_HTML

    out = args.out or Y_VISUALIZATION_HTML
    out = out.resolve()
